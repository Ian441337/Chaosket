...
public class ChaosketModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<TravelancherTileEntity>> TRAVELANCHER = REGISTRY.register("travelancher", () -> BlockEntityType.Builder.of(TravelancherTileEntity::new, ChaosketModBlocks.TRAVELANCHER.get()).build(null));

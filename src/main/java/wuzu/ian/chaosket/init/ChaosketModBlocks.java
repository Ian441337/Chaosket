...
import wuzu.ian.chaosket.block.TestskinblockBlock;
...
public class ChaosketModBlocks {
	...
	public static final RegistryObject<Block> TESTSKINBLOCK = REGISTRY.register("testskinblock", () -> new TestskinblockBlock());
}

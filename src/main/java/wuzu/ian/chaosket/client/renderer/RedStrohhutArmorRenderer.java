...
import wuzu.ian.chaosket.item.model.RedStrohhutModel;
...
public class RedStrohhutArmorRenderer extends GeoArmorRenderer<RedStrohhutItem> {
	public RedStrohhutArmorRenderer() {
		super(new RedStrohhutModel());
	...
	@Override
	public RenderType getRenderType(RedStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
import wuzu.ian.chaosket.item.model.ChaosiumSuitModel;
...
public class ChaosiumSuitArmorRenderer extends GeoArmorRenderer<ChaosiumSuitItem> {
	public ChaosiumSuitArmorRenderer() {
		super(new ChaosiumSuitModel());
	...
	@Override
	public RenderType getRenderType(ChaosiumSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

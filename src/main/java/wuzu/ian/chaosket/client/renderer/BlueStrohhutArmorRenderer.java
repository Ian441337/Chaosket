...
import wuzu.ian.chaosket.item.model.BlueStrohhutModel;
...
public class BlueStrohhutArmorRenderer extends GeoArmorRenderer<BlueStrohhutItem> {
	public BlueStrohhutArmorRenderer() {
		super(new BlueStrohhutModel());
	...
	@Override
	public RenderType getRenderType(BlueStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
import wuzu.ian.chaosket.item.model.LilaStrohhutModel;
...
public class LilaStrohhutArmorRenderer extends GeoArmorRenderer<LilaStrohhutItem> {
	public LilaStrohhutArmorRenderer() {
		super(new LilaStrohhutModel());
	...
	@Override
	public RenderType getRenderType(LilaStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

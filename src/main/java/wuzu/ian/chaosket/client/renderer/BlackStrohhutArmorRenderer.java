...
import wuzu.ian.chaosket.item.model.BlackStrohhutModel;
...
public class BlackStrohhutArmorRenderer extends GeoArmorRenderer<BlackStrohhutItem> {
	public BlackStrohhutArmorRenderer() {
		super(new BlackStrohhutModel());
	...
	@Override
	public RenderType getRenderType(BlackStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
import wuzu.ian.chaosket.item.model.WhiteStrohhutModel;
...
public class WhiteStrohhutArmorRenderer extends GeoArmorRenderer<WhiteStrohhutItem> {
	public WhiteStrohhutArmorRenderer() {
		super(new WhiteStrohhutModel());
	...
	@Override
	public RenderType getRenderType(WhiteStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
import wuzu.ian.chaosket.item.model.ChaosiumarmorModel;
...
public class ChaosiumarmorArmorRenderer extends GeoArmorRenderer<ChaosiumarmorItem> {
	public ChaosiumarmorArmorRenderer() {
		super(new ChaosiumarmorModel());
	...
	@Override
	public RenderType getRenderType(ChaosiumarmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
import wuzu.ian.chaosket.item.model.GreenStrohhutModel;
...
public class GreenStrohhutArmorRenderer extends GeoArmorRenderer<GreenStrohhutItem> {
	public GreenStrohhutArmorRenderer() {
		super(new GreenStrohhutModel());
	...
	@Override
	public RenderType getRenderType(GreenStrohhutItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
public class ChaosaltarguiScreen extends AbstractContainerScreen<ChaosaltarguiMenu> {

	private final static HashMap<String, Object> guistate = ChaosaltarguiMenu.guistate;

	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ChaosaltarguiScreen(ChaosaltarguiMenu container, Inventory inventory, Component text) {

...
public class CapsuelTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public CapsuelTileEntity(BlockPos pos, BlockState state) {
		super(ChaosketModBlockEntities.CAPSUEL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CapsuelTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CapsuelTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}

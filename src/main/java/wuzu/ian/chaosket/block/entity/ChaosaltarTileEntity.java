...
public class ChaosaltarTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public ChaosaltarTileEntity(BlockPos pos, BlockState state) {
		super(ChaosketModBlockEntities.CHAOSALTAR.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ChaosaltarTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ChaosaltarTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ChaosaltarguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

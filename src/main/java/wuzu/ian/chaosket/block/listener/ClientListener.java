...
import wuzu.ian.chaosket.block.renderer.TravelancherTileRenderer;
...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(ChaosketModBlockEntities.TRAVELANCHER.get(), context -> new TravelancherTileRenderer());
	}
}

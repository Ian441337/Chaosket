...
public class FireflyEntity extends PathfinderMob implements GeoEntity {
	...
	public FireflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChaosketModEntities.FIREFLY.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ChaosketModEntities.FIREFLY.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

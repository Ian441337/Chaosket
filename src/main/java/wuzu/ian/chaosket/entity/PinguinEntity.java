...
import wuzu.ian.chaosket.procedures.ShaderProcedure;
...
public class PinguinEntity extends PathfinderMob implements GeoEntity {
	...
	public PinguinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChaosketModEntities.PINGUIN.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "pinguin");
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.COOKED_COD));
	}
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		ShaderProcedure.execute(this.level(), this);
	}
